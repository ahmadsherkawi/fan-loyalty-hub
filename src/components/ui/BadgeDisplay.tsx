        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            <Icon className={cn(
              ...
              badge.earned ? colors.icon : 'text-muted-foreground'
            )} />
...
export function computeFanBadges(stats: {
  ...
  return [
    ...
    },
    {
      ...
      progress: stats.leaderboardRank !== undefined 
        ? Math.max(0, 100 - ((stats.leaderboardRank - 1) * 10))
        : 0,
      requirement: stats.leaderboardRank 
        ? `Current rank: #${stats.leaderboardRank}` 
